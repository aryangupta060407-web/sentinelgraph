...
type CaseAnswer = {
  ...
  agent?: {
    ...
    returned_evidence?: { type: string; response: string; source: string; simulated: boolean; status: string; reason: string }[];
